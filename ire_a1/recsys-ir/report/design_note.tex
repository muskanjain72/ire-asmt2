...
-- History Embeddings & -0.0118 & -0.0106 & -0.0112 & -0.0104 & -0.0138 & -0.0112 & -0.0116 & -0.0110 \\
...
\begin{equation}
\text{Position Bias} > \text{Category Affinity} > \text{Popularity Prior} > \text{History Embeddings} > \text{Freshness} > \text{Session Dynamics}.
\end{equation}
